...
Actuellement il n'existe que des applications agenda permettant de se créer un agenda personnaliser, mais pas de proposer des activités ou événements entre amis ou pas a un moment donnée, en exploitant les informations rentrer par l'utilisateur dans l'agenda et données recueilli.
Actuellement, il y a beaucoup d'informations et de propositions en ligne qui concernent les loisirs. Le seul problème est que la recherche de celles-ci consomme énormément du temps, que nous pouvons utiliser pour d'autres questions plus sérieuses. Cette application est conçue pour donner au client un calendrier, afin qu'il combine efficacement le travail et les loisirs. En outre, ce produit prend en compte ses préférences, en maintenant que les plus efficaces choix. Il vise à faciliter l'organisation du temps et d'améliorer sa qualité.
