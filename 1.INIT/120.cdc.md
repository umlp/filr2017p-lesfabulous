...
|----	|------------	|-------------	|-------------	|
|  01  	|   Le produit doit être utilisable sur Android	4.0 | Comme Android est un système d'exploitation largement utilisé, cela favorisera l'utilisation de ce produit|   Le produit est téléchargeable sur tous les Smartphones et fonctionne sur toutes les versions de Android     	|
