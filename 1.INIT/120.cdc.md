...
- L'application devoit accéder les sites officiels pour proposer des activités légales au client (qui ne contravient pas à la loi du pays dans lequel se trouve l'utilisateur).
